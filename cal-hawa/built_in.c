...
/*   Updated: 2020/01/09 14:34:37 by cal-hawa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				launch_built_in(char **argv, t_env *env)
{
	...
	while (argv[argc])
		argc++;
	n = -1;
	if (ft_strcmp(argv[0], "cd") == 0 && (n = 1))
		ft_cd(argc, argv, env);
	else if (ft_strcmp(argv[0], "export") == 0 && (n = 1))
		ft_export(argc, argv, env);
	else if (ft_strcmp(argv[0], "unset") == 0 && (n = 1))
		ft_unset(argc, argv, env);
	else if (ft_strcmp(argv[0], "exit") == 0 && (n = 1))
